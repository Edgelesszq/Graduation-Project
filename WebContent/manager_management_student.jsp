...
<body>
<% List<Student> list=(List<Student>)request.getAttribute("rStudents"); %>
       ...
       <div class="container">
           <div class="row">
                  ...
                  <div class="col-md-4">
                   <ul class="nav nav-pills nav-stacked">
                        <li role="presentation" > <a href="main_manager.jsp">首页</a></li>
						  ...
						  <li role="presentation" class="active"><a href="allStudent">管理学生用户</a></li>
                 ...
                 <%} %>
                              <tr><td align="center" colspan="6"><%=request.getAttribute("bar4") %></td></tr>

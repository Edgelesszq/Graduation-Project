           ...
           <div class="row">
                  ...
                  <div class="col-md-4">
                   <ul class="nav nav-pills nav-stacked">
						  ...
						  <li role="presentation" class="active"><a href="allTeacher">管理老师账户</a></li>
                  ...
                  <tr>
                  <td><%=list.get(i).getTeacher_id() %></td>
                  <td><%=list.get(i).getTeacher_username() %></td>
                  <td><%=list.get(i).getTeacher_password() %></td>
